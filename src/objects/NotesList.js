...
var fifth = new Note(5,"tiny fam","e33",d.toDateString(),true,"#0097A7");
var sixth = new Note(6,"Dickbutt lmao dfsdlfjsdlkfjlef","e33",d.toDateString(),true,"#00796B");
var seventh = new Note(7,"Why are you running fam","e33",d.toDateString(),true,"#455A64");
var eighth = new Note(8,"Go to sleep","e33",d.toDateString(),true,"#E65100");
var ninth = new Note(9,"werasdasdawdasdadadawd \nadawdadwd","e33",d.toDateString(),true,"#BF360C");
...
var fourteenth = new Note(14,"werasdasdawdasdadadawd \nadawdadwd","e33",d.toDateString(),true,"#01579B");
var fifthteenth = new Note(15,"werasdasdawdasdadadawd","e33",d.toDateString(),true,"#0D47A1");
